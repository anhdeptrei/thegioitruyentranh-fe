...
//public route
const publicRoutes = [
    { path: '/home', component: AdminHome, layout: AdminDefaultLayout, globle: GlobalStylesAdmin },
    { path: '/adminsetting', component: AdminSetting, layout: AdminDefaultLayout, globle: GlobalStylesAdmin },
    { path: '/stories', component: Stories, layout: AdminDefaultLayout, globle: GlobalStylesAdmin },
    { path: '/users', component: Users, layout: AdminDefaultLayout, globle: GlobalStylesAdmin },
    { path: '/edit-users', component: EditUsers, layout: AdminDefaultLayout, globle: GlobalStylesAdmin },
    { path: '/categories', component: Categories, layout: AdminDefaultLayout, globle: GlobalStylesAdmin },
    { path: '/edit-category', component: EditCategory, layout: AdminDefaultLayout, globle: GlobalStylesAdmin },
    { path: '/support', component: Support, layout: AdminDefaultLayout, globle: GlobalStylesAdmin },
    { path: '/edit-stories', component: EditStory, layout: AdminDefaultLayout, globle: GlobalStylesAdmin },
    { path: '/storychapter', component: Storychapter, layout: AdminDefaultLayout, globle: GlobalStylesAdmin },
    { path: '/storydetail', component: Storydetail, layout: AdminDefaultLayout, globle: GlobalStylesAdmin },
    { path: '/edit-chapter', component: EditChapter, layout: AdminDefaultLayout, globle: GlobalStylesAdmin },
